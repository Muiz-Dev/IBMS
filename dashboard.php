        ...
        <nav class="bg-white shadow-sm">
            ...
            <div class="sm:hidden" id="mobile-menu">
                <div class="pt-2 pb-3 space-y-1">
                    ...
                    <a href="#" class="border-transparent text-gray-600 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-800 block pl-3 pr-4 py-2 border-l-4 text-base font-medium">Invoices</a>
                    <a href="#" class="border-transparent text-gray-600 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-800 block pl-3 pr-4 py-2 border-l-4 text-base font-medium">Clients</a>
                ...
                <div class="pt-4 pb-3 border-t border-gray-200">
                    <div class="flex items-center px-4">
                        ...
                        <div class="ml-3">
                            ...
                            <div class="text-sm font-medium text-gray-500">example@email.com</div>
                        </div>
                    </div>
        ...
        <main class="flex-1">
            <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
                <div class="px-4 py-6 sm:px-0">
                    ...
                    <p class="mt-2 text-sm text-gray-600">Here's an overview of your account</p>
                </div>
